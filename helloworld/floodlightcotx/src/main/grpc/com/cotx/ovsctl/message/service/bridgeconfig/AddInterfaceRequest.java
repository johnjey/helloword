...
private static final long serialVersionUID = 0L;
  ...
  protected FieldAccessorTable
    ...
    return BridgeConfigProto.internal_static_BridgeConfig_AddInterfaceRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            AddInterfaceRequest.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof AddInterfaceRequest)) {
      return super.equals(obj);
    }
    AddInterfaceRequest other = (AddInterfaceRequest) obj;
  ...
  public static AddInterfaceRequest parseFrom(
  ...
  public static AddInterfaceRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static AddInterfaceRequest parseFrom(
  ...
  public static AddInterfaceRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static AddInterfaceRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static AddInterfaceRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(AddInterfaceRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public AddInterfaceRequest getDefaultInstanceForType() {
      return AddInterfaceRequest.getDefaultInstance();
    }

    public AddInterfaceRequest build() {
      AddInterfaceRequest result = buildPartial();
    ...
    public AddInterfaceRequest buildPartial() {
      AddInterfaceRequest result = new AddInterfaceRequest(this);
      if (portRequestBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof AddInterfaceRequest) {
        return mergeFrom((AddInterfaceRequest)other);
      } else {
    ...
    public Builder mergeFrom(AddInterfaceRequest other) {
      if (other == AddInterfaceRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      AddInterfaceRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (AddInterfaceRequest) e.getUnfinishedMessage();
  ...
  private static final AddInterfaceRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AddInterfaceRequest();
  }

  public static AddInterfaceRequest getDefaultInstance() {
