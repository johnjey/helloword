...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 74: {
            ...
            nONE_ = input.readMessage(VlanId.PARSER, extensionRegistry);
            if (subBuilder != null) {
          ...
          case 82: {
            ...
            aNY_ = input.readMessage(VlanId.PARSER, extensionRegistry);
            if (subBuilder != null) {
  ...
  private volatile Object sTRINGNONE_;
  /**
  ...
  private volatile Object sTRINGNUMERICNONE_;
  /**
   ...
   * <code>required string STRING_NUMERIC_NONE = 6 [default = "-1"];</code>
   */
  public String getSTRINGNUMERICNONE() {
    Object ref = sTRINGNUMERICNONE_;
    if (ref instanceof String) {
      return (String) ref;
    } else {
      com.google.protobuf.ByteString bs = 
  ...
  private volatile Object sTRINGANY_;
  /**
   ...
   * <code>required string STRING_ANY = 7 [default = "Any"];</code>
   */
  public String getSTRINGANY() {
    Object ref = sTRINGANY_;
    if (ref instanceof String) {
      return (String) ref;
    } else {
      com.google.protobuf.ByteString bs = 
   ...
   * <code>required .VlanId NONE = 9;</code>
   */
  public VlanId getNONE() {
    return nONE_ == null ? VlanId.getDefaultInstance() : nONE_;
  }
  /**
   * <pre>
   *TODO
   ...
   * <code>required .VlanId ANY = 10;</code>
   */
  public VlanId getANY() {
    return aNY_ == null ? VlanId.getDefaultInstance() : aNY_;
  }
  /**
   * <code>required .VlanId ANY = 10;</code>
   */
  ...
  public static VlanId parseFrom(
  ...
  public static VlanId parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static VlanId parseFrom(
  ...
  public static VlanId parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static VlanId parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static VlanId parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(VlanId prototype) {
  ...
  public static final class Builder extends
    ...
    public VlanId getDefaultInstanceForType() {
      return VlanId.getDefaultInstance();
    }

    public VlanId build() {
      VlanId result = buildPartial();
    ...
    public VlanId buildPartial() {
      VlanId result = new VlanId(this);
    ...
    public Builder mergeFrom(VlanId other) {
      if (other == VlanId.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      VlanId parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (VlanId) e.getUnfinishedMessage();
    ...
    private Object sTRINGNONE_ = "None";
    /**
     * <code>required string STRING_NONE = 5 [default = "None"];</code>
     */
    public boolean hasSTRINGNONE() {
  ...
  bitField0_ |= 0x00000010;
    ...
    private Object sTRINGNUMERICNONE_ = "-1";
    /**
     * <code>required string STRING_NUMERIC_NONE = 6 [default = "-1"];</code>
     */
    public boolean hasSTRINGNUMERICNONE() {
  ...
  bitField0_ |= 0x00000040;
    ...
    private VlanId nONE_ = null;
    private com.google.protobuf.SingleFieldBuilderV3<
        VlanId, Builder, VlanIdOrBuilder> nONEBuilder_;
    /**
     * <pre>
     *TODO
     *这两个的值是在VlanId.java中，通过调用方法来赋值的，这里我就暂时不给它默认值了。
     ...
     * <code>required .VlanId NONE = 9;</code>
     */
    public Builder setNONE(VlanId value) {
      if (nONEBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>required .VlanId NONE = 9;</code>
     */
    public Builder mergeNONE(VlanId value) {
      if (nONEBuilder_ == null) {
        if (((bitField0_ & 0x00000100) == 0x00000100) &&
            nONE_ != null &&
            nONE_ != VlanId.getDefaultInstance()) {
          nONE_ =
            VlanId.newBuilder(nONE_).mergeFrom(value).buildPartial();
        } else {
          nONE_ = value;
        }
        onChanged();
    ...
    public VlanIdOrBuilder getNONEOrBuilder() {
      if (nONEBuilder_ != null) {
        ...
        return nONE_ == null ?
            VlanId.getDefaultInstance() : nONE_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        VlanId, Builder, VlanIdOrBuilder>
        getNONEFieldBuilder() {
      if (nONEBuilder_ == null) {
    ...
    private VlanId aNY_ = null;
    private com.google.protobuf.SingleFieldBuilderV3<
        VlanId, Builder, VlanIdOrBuilder> aNYBuilder_;
    /**
     * <code>required .VlanId ANY = 10;</code>
     */
    public boolean hasANY() {
     ...
     * <code>required .VlanId ANY = 10;</code>
     */
    public Builder setANY(VlanId value) {
      if (aNYBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>required .VlanId ANY = 10;</code>
     */
    public Builder mergeANY(VlanId value) {
      if (aNYBuilder_ == null) {
        if (((bitField0_ & 0x00000200) == 0x00000200) &&
            aNY_ != null &&
            aNY_ != VlanId.getDefaultInstance()) {
          aNY_ =
            VlanId.newBuilder(aNY_).mergeFrom(value).buildPartial();
        } else {
          aNY_ = value;
        }
        onChanged();
    ...
    public VlanIdOrBuilder getANYOrBuilder() {
      if (aNYBuilder_ != null) {
        ...
        return aNY_ == null ?
            VlanId.getDefaultInstance() : aNY_;
      }
    }
    /**
     * <code>required .VlanId ANY = 10;</code>
  ...
  private static final VlanId DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new VlanId();
  }

  public static VlanId getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  @Deprecated public static final com.google.protobuf.Parser<VlanId>
      PARSER = new com.google.protobuf.AbstractParser<VlanId>() {
    public VlanId parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new VlanId(input, extensionRegistry);
    }
  };

  public static com.google.protobuf.Parser<VlanId> parser() {
    return PARSER;
  }

  @Override
  public com.google.protobuf.Parser<VlanId> getParserForType() {
    return PARSER;
  }
